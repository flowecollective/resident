...
export const GlobalStyle = () => {
  const css = [
    ...
    "  .skills-progress-row{flex-direction:column !important;gap:8px !important}",
    "  .skills-progress-row>div:last-child{flex-direction:row !important;justify-content:space-around !important}",
    "  .skill-focus-grid{grid-template-columns:1fr !important}",
    "  .skill-card-header{flex-wrap:wrap}",
    "  .skill-card-stats{flex-wrap:wrap;gap:6px !important}",
    "}",
